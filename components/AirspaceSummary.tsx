...
export default function AirspaceSummary() {
  const summary = useQuery(api.flights.getLatestFlightSummary);
    ...
    return (
      <div className="rounded-lg border border-dashed border-zinc-700 p-6 text-center">
        <p className="text-sm text-zinc-500">
          Flight status summary generating — check back shortly.
        </p>
      </div>
    );
  }
